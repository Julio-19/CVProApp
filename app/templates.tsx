...
const TEMPLATES: Template[] = [
  ...
  { id: 'sunset_warm',      nom: 'Sunset Warm',        prix: 1500, categorie: 'Créatif' },
  { id: 'arctic_white',     nom: 'Arctic White',       prix: 1000, categorie: 'Minimal' },
  { id: 'midnight_pro',     nom: 'Midnight Pro',       prix: 2000, categorie: 'Luxe' },
  { id: 'copper_elegant',   nom: 'Copper Elegant',     prix: 2000, categorie: 'Luxe' },
  { id: 'forest_green',     nom: 'Forest Green',       prix: 1500, categorie: 'Nature' },
  { id: 'royal_purple',     nom: 'Royal Purple',       prix: 2000, categorie: 'Luxe' },
  { id: 'sand_minimal',     nom: 'Sand Minimal',       prix: 1000, categorie: 'Minimal' },
  { id: 'tech_dark',        nom: 'Tech Dark',          prix: 2500, categorie: 'Tech' },
  { id: 'coral_fresh',      nom: 'Coral Fresh',        prix: 1500, categorie: 'Créatif' },
  { id: 'gold_black',       nom: 'Gold & Black',       prix: 2500, categorie: 'Luxe' },
  { id: 'mint_clean',       nom: 'Mint Clean',         prix: 1000, categorie: 'Minimal' },
  { id: 'burgundy_classic', nom: 'Burgundy Classic',   prix: 1500, categorie: 'Corporate' },
  { id: 'sky_creative',     nom: 'Sky Creative',       prix: 1500, categorie: 'Créatif' },
  { id: 'charcoal_pro',     nom: 'Charcoal Pro',       prix: 2000, categorie: 'Corporate' },
  { id: 'peach_soft',       nom: 'Peach Soft',         prix: 1000, categorie: 'Doux' },
  { id: 'indigo_modern',    nom: 'Indigo Modern',      prix: 2000, categorie: 'Moderne' },
  { id: 'olive_natural',    nom: 'Olive Natural',      prix: 1500, categorie: 'Nature' },
  { id: 'ruby_luxe',        nom: 'Ruby Luxe',          prix: 2500, categorie: 'Luxe' },
  { id: 'steel_corporate',  nom: 'Steel Corporate',    prix: 2000, categorie: 'Corporate' },
  { id: 'lavender_soft',    nom: 'Lavender Soft',      prix: 1000, categorie: 'Doux' },
  { id: 'amber_warm',       nom: 'Amber Warm',         prix: 1500, categorie: 'Chaud' },
  { id: 'ink_minimal',      nom: 'Ink Minimal',        prix: 1000, categorie: 'Minimal' },
  { id: 'azure_clean',      nom: 'Azure Clean',        prix: 1500, categorie: 'Moderne' },
  { id: 'mahogany_rich',    nom: 'Mahogany Rich',      prix: 2000, categorie: 'Luxe' },
  { id: 'lime_tech',        nom: 'Lime Tech',          prix: 2000, categorie: 'Tech' },
  { id: 'plum_elegant',     nom: 'Plum Elegant',       prix: 2000, categorie: 'Luxe' },
  { id: 'graphite_pro',     nom: 'Graphite Pro',       prix: 1500, categorie: 'Corporate' },
  { id: 'jade_fresh',       nom: 'Jade Fresh',         prix: 1500, categorie: 'Nature' },
  { id: 'terracotta_warm',  nom: 'Terracotta Warm',    prix: 1500, categorie: 'Chaud' },
  { id: 'cobalt_modern',    nom: 'Cobalt Modern',      prix: 2000, categorie: 'Moderne' },
  { id: 'cream_luxe',       nom: 'Cream Luxe',         prix: 2000, categorie: 'Luxe' },
  { id: 'carbon_tech',      nom: 'Carbon Tech',        prix: 2500, categorie: 'Tech' },
  { id: 'sage_minimal',     nom: 'Sage Minimal',       prix: 1000, categorie: 'Minimal' },
  { id: 'wine_classic',     nom: 'Wine Classic',       prix: 1500, categorie: 'Classic' },
  { id: 'topaz_bright',     nom: 'Topaz Bright',       prix: 1500, categorie: 'Coloré' },
  { id: 'ebony_gold',       nom: 'Ebony Gold',         prix: 2500, categorie: 'Luxe' },
  { id: 'blush_modern',     nom: 'Blush Modern',       prix: 1000, categorie: 'Doux' },
  { id: 'pine_forest',      nom: 'Pine Forest',        prix: 1500, categorie: 'Nature' },
  { id: 'denim_casual',     nom: 'Denim Casual',       prix: 1000, categorie: 'Décontracté' },
  { id: 'rose_gold',        nom: 'Rose Gold',          prix: 2500, categorie: 'Luxe' },
  { id: 'space_dark',       nom: 'Space Dark',         prix: 2000, categorie: 'Tech' },
  { id: 'citrus_fresh',     nom: 'Citrus Fresh',       prix: 1000, categorie: 'Coloré' },
  { id: 'mocha_warm',       nom: 'Mocha Warm',         prix: 1500, categorie: 'Chaud' },
  { id: 'glacier_cool',     nom: 'Glacier Cool',       prix: 1500, categorie: 'Cool' },
  { id: 'amber_dark',       nom: 'Amber Dark',         prix: 2000, categorie: 'Sombre' },
  { id: 'electric_blue',    nom: 'Electric Blue',      prix: 2000, categorie: 'Coloré' },
  { id: 'dusty_rose',       nom: 'Dusty Rose',         prix: 1000, categorie: 'Doux' },
  { id: 'forest_dark',      nom: 'Forest Dark',        prix: 1500, categorie: 'Nature' },
  { id: 'ivory_classic',    nom: 'Ivory Classic',      prix: 1500, categorie: 'Classic' },
  { id: 'neon_dark',        nom: 'Neon Dark',          prix: 2500, categorie: 'Tech' },
  { id: 'sepia_vintage',    nom: 'Sepia Vintage',      prix: 2000, categorie: 'Vintage' },
  { id: 'arctic_dark',      nom: 'Arctic Dark',        prix: 2000, categorie: 'Sombre' },
  { id: 'blaze_orange',     nom: 'Blaze Orange',       prix: 1500, categorie: 'Coloré' },
  { id: 'storm_grey',       nom: 'Storm Grey',         prix: 1500, categorie: 'Corporate' },
  { id: 'spring_green',     nom: 'Spring Green',       prix: 1000, categorie: 'Nature' },
  { id: 'velvet_dark',      nom: 'Velvet Dark',        prix: 2500, categorie: 'Luxe' },
];
